    ...
    public class IndexModel : PageModel
    {
                ...
                string uf)
        {
            ...
            foreach (var ponto in pontosOsm)
            {
                ...
                {
                    // Muitos pontos do OpenStreetMap não possuem CNPJ, telefone
                    // ou endereço completo. Eles continuam sendo farmácias reais
                    // dentro do raio e devem aparecer para o usuário, mas sem
                    // permitir captura até o CNPJ ser identificado.
